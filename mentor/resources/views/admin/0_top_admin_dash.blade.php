...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets2/img/profile-img.jpg') }}" rel="icon">
  <link href="{{ asset('assets2/img/profile-img.jpg') }}" rel="apple-touch-icon">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <img class="rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/admin_images/' . $profileData->photo) : url('upload/no_image.jpg') }}" alt="profile" style="height: 30px; width: 30px;">
